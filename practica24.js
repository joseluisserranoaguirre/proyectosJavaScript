const arrayProfesionales  = [
 ...
 /*  arrayProfesionales.forEach(function(persona){
    console.log(persona.nombre + " - " + persona.especialidad);
  })
  


  let incrementar= arrayProfesionales.map(function(persona){
    persona.honorarioConsulta = persona.honorarioConsulta*1.05
    return persona
  })
...
/* let profesionalesDeshabilitados = arrayProfesionales.filter(function(persona){
    return persona.estaHabilitado===false
})
...
/* let profesionalesHabilitados= arrayProfesionales.filter(function(persona){
    return persona.estaHabilitado===true
})
...
/* let arquitectos= arrayProfesionales.filter(function(persona){
    return persona.especialidad === "Arquitecto"
})
...
/* profesionalesDeshabilitados.map(function(persona){
   persona.estaHabilitado= true
   return persona
})
...
let cantidadTotalConsultas = arrayProfesionales.reduce(function(total,persona){
    
    return total + persona.cantidadConsultas;
},0)
...
let arrayRecaudacion = arrayProfesionales.map(function(personas){
    let array = {
        nombre:personas.nombre,
        especialidad: personas.especialidad,
        recaudacion: personas.cantidadConsultas*personas.honorarioConsulta
